...
In this vignette we show how to use the `funcharts` package to apply the methods proposed in Centofanti et al. (2021) to build the functional regression control chart, when we have a functional response variable and multivariate functional covariates.
