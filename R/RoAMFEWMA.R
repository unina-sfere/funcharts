...
#' print(mod$lambda)
#' print(mod$k)
#' cc <- RoAMFEWMA_PhaseII(mfdobj_2 = rbind_mfd(mfdobj_I[1:100], mfdobj_II),
#'                       mod_1 = mod)
  ...
  for (ii in 1:n_lambda) {
    ...
    for (jj in 1:n_k) {
      ...
      mod_ii_jj <- list(mod_1 = mod_1_AMFEWMA_list[[ii]][[jj]],
                        lambda = lambda,
                        k = k)
      mod_2_AMFEWMA_big <- RoAMFEWMA_PhaseII(mfdobj_2 = fase2_big,
                                             mod_1 = mod_ii_jj,
                                             n_seq_2 = n_seq,
                                             l_seq_2 = l_seq)
      mod_2_AMFEWMA_small <- RoAMFEWMA_PhaseII(mfdobj_2 = fase2_small,
                                               mod_1 = mod_ii_jj,
                                               n_seq_2 = n_seq,
                                               l_seq_2 = l_seq)
